...
class Crud {
    ...
    public function crear($tabla) {
        ...
        $sql = "INSERT INTO " . $nombreTabla . " (" . $camposTabla . ") VALUES ('" . $datosObjeto . "');";
    ...
    public function modificar($tabla) {
        ...
        $sql = "UPDATE " . $nombreTabla . " SET " . $datosObjeto . " WHERE " . $valorId . ";";
    ...
    public function eliminar($tabla) {
        ...
        $sql = "DELETE FROM " . $nombreTabla . " WHERE " . $valorId . ";";
    ...
    public function buscarPorId($tabla) {
        ...
        $sql = "SELECT * FROM " . $nombreTabla . " WHERE " . $valorId . ";";
